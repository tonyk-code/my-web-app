...
export default function SignupForm() {
  return (
    <div className="py-5 px-20 flex flex-col text-center rounded-tl-4xl rounded-tr-4xl bg-white md:rounded-tr-none md:rounded-tl-[60px] md:rounded-bl-[60px] md:h-screen md:w-[50%] ">
      ...
      <p className="text-[#102226b6]">
        Start tracking your income and expenses
      </p>
      <form>
        <InputField type="text" icon="user" placeholder="Full Name" />
        <InputField type="email" icon="mail" placeholder="Email" />
        <InputField type="password" icon="lock" placeholder="Password" />
        <InputField
          type="password"
          icon="lock"
        ...
        <motion.button
          ...
          type="submit"
          className="mt-8 font-bold w-full py-3 rounded-lg transition-all duration-300 hover:shadow-lg hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-2 group cursor-pointer"
